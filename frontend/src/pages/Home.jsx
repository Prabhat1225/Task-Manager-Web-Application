...
const Home = () => {
  ...
  return (
    <>
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-orange-300 text-white h-[40vh] py-8 text-center' >
            <h1 className='text-2xl'> Task Manager Web Application</h1>
            <Link to="/signup" className='mt-10 text-xl block space-x-2 hover:space-x-4'>
              <span className='transition-[margin]'>MANAGE YOUR TASK HERE</span>
